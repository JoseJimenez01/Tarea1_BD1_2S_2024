...
public partial class Empleado
{
    ...
    [Required(ErrorMessage = "El nombre no puede quedar en blanco")]
    [RegularExpression(@"^[A-Za-z]+$", ErrorMessage = "El nombre pude contener letras, espacios, tildes o un guión")]
    [MaxLength(3, ErrorMessage = "El nombre no puede exceder los 128 caracteres")]
    ...
    //[Range(1.00, 999999999.99,ErrorMessage = "El salario debe estar entre 1.00 y 999 999 999.99")]
